 ...
 * @param imageUrl 图片地址
 */
Animation.prototype.changePosition = function (ele, positions, imageUrl,r = 200/640*750) {
	...
	if (len) {
		...
		taskFn = function (next, time) {
			...
			//改变dom对象的背景图片位置
			ele.style.backgroundPosition = position[0]/r + 'rem ' + position[1]/r + 'rem';
			//当前任务执行完毕
			if (index === len) {
				next();
			}
